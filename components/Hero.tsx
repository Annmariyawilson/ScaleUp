...
function Hero() {
  return (
    <section className="w-full flex flex-col items-center px-2 py-1 relative overflow-hidden">
      {/* --- RESPONSIVE HEADING SECTION --- */}
      <div className="text-center mb-8">
        <h1 className="text-xl md:text-[85px] mb-2 md:mb-18">
          <span
            style={{ color: "#418CFF", fontWeight: "600" }}
            className="md:ml-90 font-gilmer"
          >
            ScaleUp Conclave{" "}
          </span>
          <img
      ...
      {/* --- MAIN CARD --- */}
      <div
        className="w-full max-w-md md:max-w-full rounded-4xl p-6 md:p-10 relative flex flex-col justify-between mt-0 md:-mt-[76px] min-h-auto md:min-h-0"
      ...
      >
        ...
        <div>
          ...
          <div className="mt-8 flex flex-col items-start gap-3 md:hidden">
            <button
              className="font-gilmer flex items-center rounded-tl-3xl rounded-tr-3xl rounded-bl-3xl gap-2 px-4 py-2 text-sm"
            ...
            <button
              className="font-gilmer text-left px-4 py-2 rounded-tl-3xl rounded-tr-3xl rounded-br-3xl text-sm"
        ...
        <div className="mt-8 md:mt-0">
          ...
          <div className="flex justify-start">
            <img
              ...
              alt="arrow button"
              className="w-16 md:w-[70px]"
            />
          </div>

          {/* Main Subtitle */}
          <h2 className="font-gilmer text-5xl md:text-7xl font-semibold mt-4 text-left">
